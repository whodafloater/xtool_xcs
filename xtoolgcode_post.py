...
take a pseudo-gcode fragment outputted by a Path object, and output real GCode
suitable for a X-Tool D1 laser cutter. This postprocessor, once placed in the
appropriate PathScripts folder, can be used directly from inside FreeCAD, via
the GUI importer or via python scripts with:

import xtoolgcode_post
xtoolgcode_post.export(object,"/path/to/file.ncc","")
"""
